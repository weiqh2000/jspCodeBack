...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">首页</a></li>
    <li><a href="<%=basePath%>admin/producttype/producttypemanage">产品类别管理</a></li>
    ...
    <form action="<%=basePath%>admin/producttype/doUpdateProductType" method="post">
    <!-- 传递页码 -->
    <input name="page" type="hidden" value="${requestScope.page}"/>
    <input name="id" type="hidden" value="${requestScope.productType.id}"/>
    <ul class="forminfo">
    ...
    <li><label>*图片</label>
        <input id="url1" name="imageUrl" type="text" class="dfinput" value="${requestScope.productType.imageUrl}" readonly="readonly"/>
    ...
    <li><label>产品描述</label>
        <textarea name="intro" cols="" rows="" class="textinput">${requestScope.productType.intro}</textarea><i>${requestScope.errors["intro"]}</i>
    </li>
