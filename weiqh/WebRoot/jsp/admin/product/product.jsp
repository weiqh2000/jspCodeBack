...
<body>
    ...
    <table class="imgtable">
        ...
        <tr>
        <td><img src="<%=basePath %>jsp/admin/product/img/${productOfEach.picUrl}" style="width:80px;height:60px;" /></td>
        ...
        <td><a href="<%=basePath %>admin/Product/toEditProduct" class="tablelink" >修改</a>     <a href="#" class="tablelink" onclick="deleteAdmin()" > 删除</a></td>
        </tr> 
        </c:forEach>
