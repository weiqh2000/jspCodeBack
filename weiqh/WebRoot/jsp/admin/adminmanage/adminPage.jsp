...
<body>
    ...
    <div class="pagin"><c:out value="${requestScope.page}"></c:out>
        ...
        <ul class="paginList">
        <li class="paginItem""><a href="<%=basePath %>go/toPageAdmin?index=1">首页</a></li>
        <li class="paginItem"><a href="<%=basePath %>go/toPageAdmin?index=${requestScope.page.pageNow-1}">上一页</a></li>

        <li class="paginItem"><a href="<%=basePath %>go/toPageAdmin?index=${requestScope.page.pageNow+1}">下一页</a></li>
        <li class="paginItem"><a href="<%=basePath %>go/toPageAdmin?index=${requestScope.page.pageCount}">尾页</a></li>
        </ul>
